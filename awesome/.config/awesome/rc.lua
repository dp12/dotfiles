...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "w", function () awful.util.spawn("kdesu shutdown -r now") end),
	...
	-- awful.key({ modkey,           }, "p",     function()  awful.util.spawn_with_shell( "exe=`dmenu_path | dmenu -b -fn '-*-terminus-*-r-normal-*-*-225-*-*-*-*-iso8859-*' -nf '#888888' -nb '#222222' -sf '#ffffff' -sb '#285577'` && exec $exe") end),
	-- awful.key({ modkey,           }, "p",     function()  awful.util.spawn_with_shell( "dmenu_run -b -fn '-*-terminus-*-r-normal-*-*-225-*-*-*-*-iso8859-*' -nf '#888888' -nb '#222222' -sf '#ffffff' -sb '#285577'` && exec $exe") end),
	awful.key({ modkey },            "p",     function () awful.util.spawn("dmenu_run -i -p 'Run command:' -fn '-*-terminus-*-r-normal-*-*-225-*-*-*-*-iso8859-*' -nb '" ..
	beautiful.bg_normal .. "' -nf '" .. beautiful.fg_normal ..
	"' -sb '" .. beautiful.bg_focus .. "' -sf '" .. beautiful.fg_focus .. "'") end),

...
# POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(context dir vcs vi-mode)
...
antidote bundle sorin-ionescu/prezto path:modules/completion
...
# if [[ -z "${KEYCHAIN_SLOT1}" ]]; then
#    eval $(keychain --eval "${KEYCHAIN_SLOT1}")
# fi
